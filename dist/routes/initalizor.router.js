...
exports.RouterInitalizor = void 0;
...
router.use(routes_1.Routes.config.imagePath, express.static(uploadPath));
                ...
                if (user) {
                    bcrypt.compare(password, user.password, function (err, result) {
                        if (result) {
                            ...
                            (0, response__util_1.sendSuccess)(res, "Login Successful", token);
                        }
                        else {
                            (0, response__util_1.sendBadRequest)(res, "Invalid credentials");
                        }
                    });
                }
                else {
...
//# sourceMappingURL=initalizor.router.js.map